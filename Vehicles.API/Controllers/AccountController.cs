    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // YA NO SE LOGUEA AUTOMÁTICAMENTE
                ...
                //var resulta2 = await _userHelper.LoginAsync(loginViewModel);
                //if (resulta2.Succeeded)
                //{
                //    return RedirectToAction("Index", "Home");
                //}
        ...
        {
            User user = await _userHelper.GetUserAsync(User.Identity.Name); // retorna el usuario logueado
            if (user == null)
            {
                return NotFound();
            }
