...
namespace Vehicles.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> AddHistory(int? id)
        {
            ...
            Vehicle vehicle = await _context.Vehicles.FindAsync(id); // cuando se utiliza Find no se pueden utilizar los Include, con FirstOrDefault sí
            if (vehicle == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> AddHistory(HistoryViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Date = DateTime.UtcNow, // hora de Londres, cuando la recuperemos la recupera en la hora local
